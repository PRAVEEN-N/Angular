...
export class ProductListComponent {
  ...
  inStock:number = this.products.filter(product => product.is_in_inventory).length;
  outOfStock:number = this.products.filter(product => !product.is_in_inventory).length;
}
